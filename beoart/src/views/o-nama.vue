<template>
  <div class="-nama-container">
    ...
    <h1 class="-nama-text">Mi smo BeoArt!</h1>
    <span class="-nama-text01">
      <span class="-nama-text02">
    ...
    <div class="-nama-stats">
      <div class="-nama-stat">
        <h1 class="-nama-text04">
          <span>50</span>
          <span>+</span>
        </h1>
        <span class="-nama-text07">Zadovoljnih kupaca</span>
      </div>
      <div class="-nama-stat1">
        <h1 class="-nama-text08"><span>369</span></h1>
        <span class="-nama-text10">Izloženih umetnina</span>
      </div>
      <div class="-nama-stat2">
        <h1 class="-nama-text11">
          <span>500</span>
          <span>+</span>
        </h1>
        <span class="-nama-text14">Poruka i ponuda</span>
      </div>
      <div class="-nama-stat3">
        <h1 class="-nama-text15"><span>24/7</span></h1>
        <span class="-nama-text17">Podrška</span>
      </div>
    </div>
    <div class="-nama-blog">
      <blog-post-card4
    ...
    <div class="-nama-banner"><h1 class="-nama-text18">Ovo je mapa</h1></div>
    <div class="-nama-social-bar">
      <span class="-nama-text19">Kontaktiraj nas</span>
      <svg viewBox="0 0 950.8571428571428 1024" class="-nama-icon">
        <path
        ...
        ></path></svg
      ><svg viewBox="0 0 877.7142857142857 1024" class="-nama-icon02">
        <path
        ...
        ></path></svg
      ><svg viewBox="0 0 602.2582857142856 1024" class="-nama-icon04">
        <path
          d="M548 6.857v150.857h-89.714c-70.286 0-83.429 33.714-83.429 82.286v108h167.429l-22.286 169.143h-145.143v433.714h-174.857v-433.714h-145.714v-169.143h145.714v-124.571c0-144.571 88.571-223.429 217.714-223.429 61.714 0 114.857 4.571 130.286 6.857z"
        ></path></svg
      ><svg viewBox="0 0 877.7142857142857 1024" class="-nama-icon06">
        <path
        ...
        ></path></svg
      ><svg viewBox="0 0 1024 1024" class="-nama-icon08">
        <path
